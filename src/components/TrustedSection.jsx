    ...
    <section className="bg-[#0B0F1A] text-white w-full px-6 md:px-16 py-16 flex flex-col gap-10">
      ...
      <div className="flex flex-col lg:flex-row items-stretch">
        ...
        <div className="w-full lg:w-[70%]">
          <video autoPlay loop muted className="rounded-xl shadow-lg w-full h-[350px] max-w-[900px] object-cover">
            <source src={assets.trading_vedio} type="video/mp4" />
          </video>
        </div>

        {/* Right Side Card */}
        <div className="bg-white text-[#0C1522] h-[350px]  rounded-xl p-8 shadow-lg  flex flex-col justify-center items-center w-full lg:w-[25%]">
