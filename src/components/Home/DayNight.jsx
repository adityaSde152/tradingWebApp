    ...
    const handleScroll = () => {
      ...
      frameId = requestAnimationFrame(() => {
        ...
        if (dayImageRef.current) {
          dayImageRef.current.style.transform = `translate3d(0, ${
            100 - progress * 100
          }%, 0)`;
        }
      ...
      <div className="sticky top-0 h-[100vh] w-full overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row  lg:justify-between items-center h-full px-4 sm:px-12">
          <div className="max-w-lg">
            ...
            <button className="mt-6 px-3 py-2 sm:px-6 sm:py-3 text-sm sm:text-xl bg-white border-2 border-green cursor-pointer text-green font-bold rounded-xl hover:bg-green/90 hover:text-white transition-colors duration-300">
              Open account
            </button>
          </div>
